...
translations = {
    'en': {
        'welcome': "Welcome",
        'hello': "Hello",
        'ready_msg': "Ready to level up today?",
        'level': "Level",
...
translations = {
    'en': {
        ...
        'proceed_to_question': "Proceed to Question"
    },
    'bm': {
        'welcome': "Selamat Datang",
        'hello': "Helo",
        'ready_msg': "Bersedia untuk naik taraf hari ini?",
        'level': "Tahap",
        'current_mastery': "Penguasaan Semasa",
        'progress_to': "Kemajuan ke Tahap",
        'xp': "XP",
        'days': "Hari",
        'missions': "Misi",
        'history': "Sejarah",
        ...
        'attempts_left': "percubaan tinggal",
        'watch_video': "Tonton Video",
        'proceed_to_question': "Teruskan ke Soalan"
    }
}